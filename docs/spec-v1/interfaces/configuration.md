...
* The interface is described as [JSON Schema](https://json-schema.org/specification.html) here: [/spec-v1/interfaces/Configuration.schema.json](https://pages.github.com/SAP/open-resource-discovery/spec-v1/interfaces/Configuration.schema.json)
