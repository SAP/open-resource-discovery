...
<details>
<summary>More Detail: How ORD helps with Self-Description</summary>
...
<details>
<summary>More UI examples with annotations</summary>
...
<details>
<summary>More UI examples with annotations and more details on UCL</summary>
...
An ORD consumer should get their information from an ORD Aggregator, where a complete overview is offered with a more consumer friendly [ORD Service](./spec-v1/index.md#ord-service) API

![ORD Consumer Role](/img/ord-role-consumer.svg 'ORD Consumer Role')

</details>

> Don't forget to have a look at the [Articles](./details/articles) 📖 and [Videos](./details/videos) 🎦 that explain ORD related topics in more detail.
